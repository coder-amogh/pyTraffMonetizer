...
VERSION = "0.0.1"
DESCRIPTION = "UNOFFICIAL Python bindings for TraffMonetizer Dashboard API"
LONG_DESCRIPTION = "A package that allows you to connect to TraffMonetizer API and interact with your data."
...
setup(
    ...
    url = "https://github.com/coder-amogh/pyTraffMonetizer",
    project_urls = {
